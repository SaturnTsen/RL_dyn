...
from src.utils import normalize_obs, process_reward
...
if __name__ == '__main__':
    ...
    for ep in range(start_ep, num_episodes):
        ...
        torch.save({
            ...
            'reward': total_reward,
            'epsilon': epsilon,
            'buffer_path': f'checkpoints/DDQN/buffer_ep{ep+1}.pkl'
        }, f'checkpoints/DDQN/checkpoint_ep{ep+1}.pth')
        buffer.save(f'checkpoints/DDQN/buffer_ep{ep+1}.pkl')
